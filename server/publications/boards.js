...
Meteor.publish('gotoBoard', function(slug) {
    check(slug, String);
    return Boards.find({slug:slug});
});

Meteor.publish('getTasks', function(boardId) {
    check(boardId, String);
    return Cards.find({
        boardId: boardId
    });    
...
Meteor.publish('getMyTasks', function(boardId) {
    check(boardId, String);
    return Cards.find({
        boardId: boardId,
        userId: this.userId
...
Meteor.publish('getAssets', function(boardId) {
    check(boardId, String);
    return Attachments.find({
        boardId: boardId
    });
...
Meteor.publish('getExpiringTasks', function(boardId) {
    check(boardId, String);
