...
$(".heading-hero_H").typed({
    strings: ["Build Teams", "Raise Funds", "Manage Productions", "Define Digital Rights", "Unlimited Access API", 'One Purpose','<span class="awesomeness fw700">Make Stories Happen</span>'],
    typeSpeed: 55,
    backSpeed: 21,
    backDelay: 1597,
    showCursor: true,
