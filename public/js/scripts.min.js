...
$(".heading-hero_H").typed({
    strings: ["Build Teams", "Community Offers", "Subscriptions and Sales ", "Digital Rights", "Access API", 'One Purpose','<span class="awesomeness fw700">Make Stories Happen</span>'],
    typeSpeed: 55,
    backSpeed: 21,
    backDelay: 1597,
    showCursor: true,
